...
val SPICE_SYSTEM: String = """You are a SPICE netlist expert assistant.
Rules:
...
- For file downloads (PDF datasheets, images, CSV, ZIP), use download_file to save into ${HostDefaults.DOWNLOAD_DIR_LABEL}, then read_file to inspect docs/text/images; always report the saved ${HostDefaults.DOWNLOAD_DIR_LABEL} location in the same reply.
