...
class ThinkingUtilsTest {
    ...
    fun chatErrorsRenderRedOnly() {
        ...
        assertTrue(isChatError("Anthropic error: invalid x-api-key"))
        assertTrue(isChatError("Gateway error: Model is unavailable"))
        assertTrue(isChatError("OpenAI error: Insufficient credits."))
        assertTrue(isChatError("Your credit balance is too low."))
